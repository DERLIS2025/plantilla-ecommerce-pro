    ...
    <>
      <main className="container-shell pb-28 pt-4 sm:pb-12 sm:pt-7 lg:pt-10">
        ...
        <nav
          ...
          className="mb-4 flex items-center gap-1 overflow-hidden text-xs text-text-soft sm:mb-6 sm:text-sm"
        >
          <Link
            href="/"
            className="shrink-0 transition hover:text-brand-700"
          >
            Inicio
          </Link>
        ...
        <Link
          href="/shop"
          className="mb-5 inline-flex items-center gap-2 text-sm font-semibold text-brand-700 transition hover:text-brand-900 sm:mb-7"
        >
        ...
        <section className="grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.9fr)] lg:gap-10">
          ...
          <div className="min-w-0">
            ...
            <h1 className="mt-3 text-3xl font-semibold leading-tight tracking-tight text-text-strong sm:text-4xl lg:text-5xl">
              {product.name}
            </h1>
            ...
            <div className="mt-6 rounded-3xl border border-brand-100 bg-white p-5 shadow-soft sm:p-6">
              ...
              <div className="mt-2 flex flex-wrap items-baseline gap-x-3 gap-y-1">
                <strong className="text-3xl font-bold tracking-tight text-brand-700 sm:text-4xl">
              ...
              <div className="mt-5 grid gap-3 text-sm text-text-soft">
                <p className="flex items-start gap-2">
                  ...
                  Asesoramiento antes de confirmar el pedido.
                </p>

                <p className="flex items-start gap-2">
                  <Check className="mt-0.5 h-4 w-4 shrink-0 text-brand-700" />
                  Materiales seleccionados para mayor duración.
                </p>

                <p className="flex items-start gap-2">
                  <Check className="mt-0.5 h-4 w-4 shrink-0 text-brand-700" />
                  Trabajo profesional con resultados garantizados.
                </p>
              </div>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                ...
                <Link
                  href="/trabajos"
                  className="inline-flex min-h-12 items-center justify-center rounded-xl border border-border bg-white px-5 text-sm font-semibold text-text-strong transition hover:border-brand-300 hover:bg-brand-50"
                >
                  Ver trabajos realizados
                </Link>
              </div>

              <p className="mt-4 flex items-center justify-center gap-1.5 text-center text-xs text-text-soft">
